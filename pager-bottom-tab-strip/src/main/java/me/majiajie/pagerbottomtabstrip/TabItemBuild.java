...
public interface TabItemBuild {
    ...
    /**
     * set default typeface for menu
     *
     * @param typeFace
     * @return {@link TabItemBuild TabItemBuild}
     */
    TabItemBuild setDefaultTypeFace(Typeface typeFace);
    ...
    /**
     * Set text size default of menu
     *
     * @param textSize text size of menu item
     * @return {@link TabItemBuild TabItemBuild}
     */
    TabItemBuild setTextSizeDefault(float textSize);

    /**
     * Set text size select mode of menu
     *
     * @param textSize
     * @return {@link TabItemBuild TabItemBuild}
     */
    TabItemBuild setTextSizeSelected(float textSize);
}
